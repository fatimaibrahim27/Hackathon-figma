...
// Corrected image paths for public directory
const OurChefs = () => {
  return (
    <div>
      <Hero />
      ...
      <section className="bg-black md:px-[135px] py-[50px]">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-[20px] mt-[50px]">
          <Image
            src="/Chef Card 1.png" // Corrected the image path
            alt="Chef 1"
            className="w-[200px] md:w-[305px] md:h-[280px] cursor-pointer"
          />
          <Image
            src="/Card 2.png" // Corrected the image path
            alt="Chef 2"
            className="w-[200px] md:w-[280px] md:h-[280px] cursor-pointer"
          />
          <Image
            src="/Card 3.png" // Corrected the image path
            alt="Chef 3"
            className="w-[200px] md:w-[280px] md:h-[280px] cursor-pointer"
          />
          <Image
            src="/Card 4.png" // Corrected the image path
            alt="Chef 4"
            className="w-[200px] md:w-[280px] md:h-[280px] cursor-pointer"
          />
        </div>
